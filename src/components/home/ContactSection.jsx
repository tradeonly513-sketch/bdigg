...
const ContactSection = () => {
  ...
  return (
    <section id="contact" ref={sectionRef} className='min-h-screen bg-black text-white relative z-30'>
      <div className='container mx-auto lg:px-12 px-6 lg:py-24 py-16'>
        <div className='text-center mb-16'>
          ...
          <p className='font-[font1] lg:text-xl text-lg lg:max-w-3xl max-w-xl mx-auto leading-relaxed text-gray-300'>
            Prêt à donner vie à votre vision? Contactez-nous pour discuter de votre projet de mariage.
          </p>
        </div>
            ...
            <div className='contact-info'>
              <div className='bg-gray-900 rounded-2xl p-6 lg:p-8'>
                ...
                <p className='font-[font1] text-base lg:text-lg text-gray-300 leading-relaxed'>
                  Nous nous engageons à répondre à toutes les demandes dans les 24 heures. Votre projet mérite notre attention immédiate.
                </p>
              </div>
            </div>
          </div>
